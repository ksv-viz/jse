...
public class TerminalConst {
    ...
    public static final String PROJECT_LIST_BY_USER_ID = "project-list-by-user-id";
    public static final String PROJECT_ADD_TO_USER_BY_IDS = "project-add-to-user-by-ids";
    public static final String PROJECT_REMOVE_FROM_USER_BY_IDS = "project-remove-from-user-by-ids";

    public static final String TASK_LIST_BY_USER_ID = "task-list-by-user-id";
    public static final String TASK_ADD_TO_USER_BY_IDS = "task-add-to-user-by-ids";
    public static final String TASK_REMOVE_FROM_USER_BY_IDS = "task-remove-from-user-by-ids";
